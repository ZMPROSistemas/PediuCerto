...
include '../services/conecta.php';
    ...
    // $endCliente= utf8_encode($_GET['endCliente']);
    $endCliente= $_GET['endCliente'];
...
<body onload="ClosePrint()">
    ...
    <div class="printCozinha print">
        ...
        <div class="dadosCliente">
            ...
            <span>End.: <?=utf8_encode($endCliente)?></span><br>
            ...
            <tbody>
                ...
                <?php
                    foreach($pedidoItens as $pedidoItens){?>
                        ...
                        <td>
                            <b><?=utf8_encode($pedidoItens['pdi_descricao'])?></b><br>
                            <?=utf8_encode($pedidoItens['pdi_obs'])?>
                        </td>
