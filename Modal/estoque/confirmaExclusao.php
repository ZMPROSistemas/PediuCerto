    ...
    <div class="modal-dialog modal-dialog-centered" role="document"> 
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="mb-0 pb-0" style="color: black !important; text-align: center;" >Todas as informações não salvas serão perdidas!</h5>
            </div>
            <div class="modal-body">
                <h3 style="color: black !important; text-align: center;" class="modal-title" id="TextoModal">Tem certeza de que deseja cancelar?</h3>
            </div>
            <div class="modal-footer my-1 py-1">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Não</button>
                <button type="button" class="btn btn-primary" data-dismiss="modal" ng-click="LimparCancelar()">Sim, tenho certeza</button> 
            </div>
        </div>
    </div>
</div>