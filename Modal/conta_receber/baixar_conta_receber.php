        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document" style="color: black;">
            <div class="modal-content" style="box-shadow: -0.5em 0.5em 0.5em rgba(0,0,0,0.5);">
                <div class="modal-header">
                    <h3 class="mb-0 pb-0" style="color: black !important;" >Baixa de Contas a Receber</h3>
                    ...
                    <div class="row " style="font-size: 0.9em !important">
	    				<div class="col-8 p-0 m-0">
                            <div class="form-group row mb-2">
                                ...
                                <div class="col">
                                    <input type="text" class="form-control form-control-sm text-left" id="nomeCliente" ng-model="nomeCliente" value="" ng-enter="seachClienteByNome(nomeCliente)" autocomplete="off" placeholder="Digite o Nome do Cliente" onKeyUp="tabenter(event,getElementById('dataPagto'))" >
                                </div>
                            </div>
                            <div class="form-group row mb-2">
