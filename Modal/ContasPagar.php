  ...
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document" style="color: black;" >
    <div class="modal-content">
      <div class="modal-header">
        <h3 class="mb-0" style="color: black !important;" >Lançar Conta a Pagar</h3>
      </div>
      <div class="modal-body">
        <div class="container-fluid">
          <form id="formConta">
            ...
            <div class="row"> <!-- FAZER NG-IF SE HÁ FILIAIS -->
              <div class="form-group col-md-12" >
                <div class="form-group form-check" >
                  <input class="form-check-input" type="checkbox" value="" id="checkRatear" ng-model="despesa.ct_rateia" ng-disabled="despesa.ct_empresa">
                  <label class="form-check-label" for="checkRatear">Ratear Conta entre Empresas?</label>
                </div>
              </div>
            </div>
            <div class="row"> <!-- FAZER NG-IF SE HÁ FILIAIS -->
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-lg btn-primary" ng-click="AdicionarDespesa(despesa, selecionarCaixa, bc_codigo, vencimento | date: 'yyyy-MM-dd')" ng-if="despesa.ct_docto && despesa.ct_tipdoc && (despesa.ct_empresa || despesa.ct_rateia) && despesa.ct_historico && notaParcelas[0].vezes && despesa.ct_cliente_forn">Lançar Conta</button>
      </div>
    </div>
  </div>
</div>
