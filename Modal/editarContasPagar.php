                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-12">
                                ...
                                <select class="form-control form-control-sm" ng-model="contas[0].ct_cliente_forn" ng-blur="verificaCampo(contas[0].ct_cliente_forn)">
                                    <option ng-repeat="dadosCliente in dadosFornecedores | filter:{pe_empresa:<?=base64_decode($empresa)?>}" ng-selected="dadosCliente.pe_nome == contas[0].ct_nome" ng-value="dadosCliente.pe_cod" >{{dadosCliente.pe_nome}}</option>
                                </select>
                            </div>
