...
$retorno = array();
 ...
 pe_end_cid_trab,
 pe_uf_trab,
 pe_foto_perfil FROM  pessoas where pe_email = '".$array['user']."' and pe_senhaApp ='".base64_decode($array['pass'])."';";

$EmailQuery = mysqli_query($conexao, $sqlEmal);
