...
function buscarListaProdutos($conexao, $empresa) {
	...
	$sql = "SELECT pd_id, pd_cod, pd_un, pd_desc, pd_subgrupo, pd_custo, pd_vista from produtos where pd_matriz = $empresa;";
