...
$hora = date('H:i:s');
    ...
    if (isset($_GET['editarContaID'])) {
        ...
        editarContaID($conexao, $editarConta['ct_id'], $editarConta['ct_docto'], $editarConta['ct_empresa'], $editarConta['ct_matriz'], $editarConta['ct_parc'], $editarConta['ct_vencto'], $editarConta['ct_valor'], $editarConta['ct_tipdoc'], $editarConta['ct_obs'], $editarConta['ct_cliente_forn'], $id, $empresa, $data, $hora, $ip);
    ...
    if (isset($_GET['baixarConta'])) {
        ...
        $dc ='D';
        baixarConta($conexao, $data, $hora, $ip, $valData['dataBaixa'], $conta['ct_valor'], $us_id, $caixa, $empresa_matriz, $token, $conta['ct_id'], $lancaCaixa['statusCheck'], $dc, $valData['tipoDoctos'],$empresa_filial);
    ...
    function listaContasRecebidas($conexao, $empresa, $dataI, $dataF, $quitado){
        ...
        and ct_vencto between '$dataI' and '$dataF';";
    ...
    function buscarContaID($conexao, $ct_id){
        $retorno = array();
        $sql ="SELECT   ct_id, ct_empresa, ct_matriz, ct_docto, ct_cliente_forn, ct_nome, ct_vencto, ct_valor, ct_parc, ct_tipdoc, ct_obs
