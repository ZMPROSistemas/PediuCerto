...
$hora = date('H:i:s');
    ...
    function totalContaReceberFast($conexao, $empresa, $ct_nome, $ct_vencto, $quitado){
        ...
        $sql = "select (select sum(ct_valorpago) FROM contas where ct_vencto < current_date() and $empresa $ct_nome $ct_vencto and ct_receber_pagar = 'R' and ct_quitado = 'N') as vencidas,
        (select sum(ct_valorpago) FROM contas where ct_vencto = current_date() and $empresa $ct_nome $ct_vencto and ct_receber_pagar = 'R' and ct_quitado = 'N') as vencendo,
        (select sum(ct_valorpago) FROM contas where ct_vencto > current_date() and $empresa $ct_nome $ct_vencto and ct_receber_pagar = 'R' and ct_quitado = 'N') as a_vencer;";
