...
if ($editarCadastrar == 'E') {
	editarEmpresa($conexao, $em_razao, $em_fanta, $em_end, $em_end_num, $em_bairro, $em_cid, $em_uf, $em_cep, $em_cnpj, $em_insc, $em_fone, $em_email, $em_responsavel, $em_cont_nome, $em_cont_fone, $em_cont_email, $id, $data, $hora, $ip, $us, $em_logo, $empresa);
	//echo "E";
...
function editarEmpresa($conexao, $em_razao, $em_fanta, $em_end, $em_end_num, $em_bairro, $em_cid, $em_uf, $em_cep, $em_cnpj, $em_insc, $em_fone, $em_email, $em_responsavel, $em_cont_nome, $em_cont_fone, $em_cont_email, $id, $data, $hora, $ip, $us, $em_logo, $empresa) {
