<?php
    ...
    if (isset($_GET['dadosSubGrupo'])) {
        ...
        if (isset($_GET['lista'])) {
            ...
            $lista = '{"result":[' . json_encode(listaSubGrupoProduto($conexao, $empresaMatriz, $sbp_descricao, $grp_descricao)). ']}';
            echo $lista;
        }
        ...
        if (isset($_GET['excluir'])) {
            ...
            $excluir = excluirGrupoProduto($conexao, $empresaMatriz, $subgrupo, $sbp_id);
        }
    }

    function listaSubGrupoProduto($conexao, $empresaMatriz, $sbp_descricao, $grp_descricao){
        $resultado = array();

        $sql = "SELECT sbp_id, sbp_codigo, sbp_empresa, sbp_matriz, sbp_descricao, sbp_grupo, 
        (select grp_descricao from grupo_prod where sbp_grupo = grp_codigo and grp_matriz = sbp_matriz and grp_empresa = sbp_empresa) as sbp_grupo_desc
        FROM subgrupo_prod where sbp_matriz = $empresaMatriz $sbp_descricao $grp_descricao order by sbp_descricao;";
