			...
			echo $dados_empresa["em_fanta"];
										...
										<!--div class="col-auto">
											<div class="input-group-btn">
												...
												<div class="col-auto">
													<md-button class="btnPesquisar pull-left" style="border: none;" ng-click="ContasRecebidas(dataI | date : 'yyyy-MM-dd', dataF | date : 'yyyy-MM-dd', empresa, buscaCliente)" style="color: white;">
