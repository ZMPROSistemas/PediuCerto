...
<style>
    ...
    border-radius: .25rem;
			...
			echo $dados_empresa["em_fanta"];
												...
												<div class="col-auto ml-2">
													<md-button class="btnPesquisar pull-left" style="border: none;" ng-click="ContasReceber(dataI | date : 'yyyy-MM-dd', dataF | date : 'yyyy-MM-dd', empresa, buscaFornec)" style="color: white;">
											...
											<table class="table table-sm table-striped" style="background-color: #FFFFFFFF; color: black;">
												...
												<tbody>
													<tr dir-paginate="contasReceber in contasReceber | orderBy:'sortKey' | itemsPerPage:20" ng-class="contasReceber.ct_vencto < dataPagto ? 'venc' : contasReceber.ct_vencto == dataPagto ? 'vencH':''" ng-dblclick="clienteSelecionadoOK(contasReceber.ct_id, contasReceber.ct_cliente_forn, contasReceber.ct_nome)">
														...
														<td><span ng-if="contasReceber.ct_canc == 'S'" class="badge badge-light" style=" text-align: left;background-color:red; color:#fff; margin-right:5px;">Cancelado</span>{{contasReceber.em_fanta}}</td>
														...
														<td style="text-align: center;">
															<button type="button" class="btn btn-outline-light p-0" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="border-width: 0; color: black;" ng-click="clienteSelecionadoOK(contasReceber.ct_id, contasReceber.ct_cliente_forn, contasReceber.ct_nome)">
