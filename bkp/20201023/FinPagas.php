...
<style>
	...
	<!--								</div>
									...
									<div class="card-footer p-2">
										<div class="form-row align-items-center">
											<div class="col-6">
												<span style="text-align: left; ">Total Pago no Período: <b class="col-auto">{{somaValorPago | currency: 'R$ '}}</b></span>
											</div>
...
<?php }?>
		   ...
		   $scope.sortKey = function(keyname){
			...
			var totalPesquisado = function(){
				...
				$scope.somaValorPago = $scope.contasRecebidos.reduce(function (accumulador, total) {return accumulador + parseFloat(total.ct_valorpago);}, 0);
