...
if(isset($_GET['salvarBalanco'])){
    ...
    $cei_idprim = verificaBalancoAberto($conexao, $cei_empresa);
...
function verificaBalancoAberto($conexao, $cei_empresa) {

    $sql = "SELECT ce_id 
            FROM cons_est where ce_empresa = $cei_empresa and ce_aberto = 'S';";
