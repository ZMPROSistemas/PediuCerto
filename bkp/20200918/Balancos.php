...
<?php if (base64_decode($empresa_acesso) == 0) {?>
	...
	echo $dados_empresa["em_fanta"];
								...
								<div class="card col-12 p-0 mt-2" style="border:none; background-color: rgba(0,0,0, .25);">
									<div class="row">
										<div class="col-6 pl-2"><span style="color:gainsboro;"><b>Balanços</b></span></div>
										<div class="col-6 pl-2"><span style="color:gainsboro;"><b>Itens do Balanço {{documento}}</b></span></div>
									</div>
								</div>
								<div class="card col-12 p-0" style="border:none;">
									<div class="row">
										<div class="table-responsive col-6 px-0" style="overflow: auto; background-color: white;">
											<table class="table table-sm table-striped pb-0" style="font-size: 0.9em !important; background-color: #FFFFFFFF; color: black; cursor: pointer;">
				...
				<?php if (substr($me_empresa, 3, 1) == 'S') {?>
																	<a class="dropdown-item" ng-click="reverterBalanco(balanco)">Reverter Balanco</a>
				<?php }?>
											...
											<dir-pagination-controls max-size="10" boundary-links="true" class="ng-isolate-scope"></dir-pagination-controls>
										</div>
										...
										<div class="table-responsive col-6 px-0" style="overflow: auto; background-color: white; border-left: 8px rgba(0,0,0, .8) solid;">
											<table class="table table-sm table-striped" style="font-size: 0.9em !important; background-color: white; color: black; width: 100%; border-left: 1px solid #E5E5E5FF;">
												<thead class="thead-dark" style="border-left: 1px solid black">
													<tr>
														<th scope="col" style="font-weight: normal; text-align: left;" ng-click="ordenar('cei_prod')">Cód</th>
