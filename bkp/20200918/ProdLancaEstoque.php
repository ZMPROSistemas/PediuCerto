					...
					<div class="modal-dialog modal-dialog-centered" role="document">
						<div class="modal-content">
							...
							<div class="modal-footer">
								...
								<button type="button" class="btn btn-primary" ng-if="empresaAcesso != '' && empresaAcesso != undefined" data-dismiss="modal" ng-click="SalvarBalanco()">Salvar</button>
							</div>
						</div>
					</div>
				</div>
