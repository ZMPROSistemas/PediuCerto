...
$ip = get_client_ip();
    ...
    if ($dados_usuario['us_email'] != $usuario) {
        ...
        if ($dados_usuario['us_status'] != 'S') {
            ...
            logSistemaLogin($conexao, $data, $hora, $ip, $us_cod, 'Efetuado Login No Sistema', $empresa, $matriz);
            header("Location: inicio.php?u=".$usuario1."&s=".$senha1."&login=true"); #redireciona para a pagina
         }
    }
