...
function dadosClienteAutorizado($conexao, $id, $situacao, $ativo, $cliente_fornecedor) {
	...
	while ($row = mysqli_fetch_assoc($resultado)) {
		...
		array_push($retorno, array(
			...
			'pe_nome' => ucwords(utf8_encode($row['pe_nome'])),
			'pe_situacao' => $row['pe_situacao'],
			'pe_endereco' => ucwords(utf8_encode($row['pe_endereco'])),
			'pe_cidade' => ucwords(utf8_encode($row['pe_cidade'])),
			'pe_uf' => mb_strtoupper(utf8_encode($row['pe_uf'])),
			'pe_bairro' => ucwords(utf8_encode($row['pe_bairro'])),
			...
			'pe_fanta' => ucwords(utf8_encode($row['pe_fanta'])),
			'pe_email' => utf8_encode($row['pe_email']),
			'pe_site' => utf8_encode($row['pe_site']),
			'pe_cont' => ucwords(utf8_encode($row['pe_cont'])),
			'pe_fonecont' => utf8_encode($row['pe_fonecont']),
			'pe_obs' => mb_strtoupper(utf8_encode($row['pe_obs'])),
			'pe_entrega' => utf8_encode($row['pe_entrega']),
			'pe_cidentrega' => ucwords(utf8_encode($row['pe_cidentrega'])),
			'pe_bairroentrega' => ucwords(utf8_encode($row['pe_bairroentrega'])),
			...
			'pe_cidcobranca' => ucwords(utf8_encode($row['pe_cidcobranca'])),
			'pe_ufcobranca' => mb_strtoupper(utf8_encode($row['pe_ufcobranca'])),
			'pe_bairrocobranca' => ucwords(utf8_encode($row['pe_bairrocobranca'])),
			...
			'pe_funcao' => ucwords(utf8_encode($row['pe_funcao'])),
			'pe_endtrab' => ucwords(utf8_encode($row['pe_endtrab'])),
			...
			'pe_conj' => ucwords(utf8_encode($row['pe_conj'])),
			'pe_conjtrab' => utf8_encode($row['pe_conjtrab']),
			'pe_funcconj' => utf8_encode($row['pe_funcconj']),
			'pe_endtrabconj' => ucwords(utf8_encode($row['pe_endtrabconj'])),
			...
			'pe_banco1' => ucwords(utf8_encode($row['pe_banco1'])),
			...
			'pe_natural' => ucwords(utf8_encode($row['pe_natural'])),
			...
			'pe_nome1' => ucwords(utf8_encode($row['pe_nome1'])),
			'pe_nome2' => ucwords(utf8_encode($row['pe_nome2'])),
			'pe_nome3' => ucwords(utf8_encode($row['pe_nome3'])),
			'pe_nome4' => ucwords(utf8_encode($row['pe_nome4'])),
			'pe_nome5' => ucwords(utf8_encode($row['pe_nome5'])),
