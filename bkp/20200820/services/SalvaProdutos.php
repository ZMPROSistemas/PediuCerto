...
if(isset($_GET['SalvarProduto'])){
	...
	if ($cadastrar_alterar == 'N') {
		...
		adicionarProduto ($conexao, $pd_empresa, $pd_matriz, $produto['pd_cod'], ucwords(strtolower($produto['pd_desc'])), $produto['pd_marca'], $produto['pd_custo'], $produto['pd_vista'], 
						...
						$produto['pd_observ'], $produto['es_est'], $produto['pd_foto_url'], $produto['pd_composicao'], $us_id, $data, $hora, $ip, $produto, $cadastrar_alterar);
	}
	else if ($cadastrar_alterar == 'E'){
		//echo 'E';
		editarProduto ($conexao, $pd_empresa, $pd_matriz, $produto['pd_id'], $produto['pd_desc'], $produto['pd_codinterno'], $produto['pd_csosn'], $produto['pd_custo'], $produto['pd_ean'], $produto['pd_foto_url'],
						...
						$produto['pd_un'], $produto['pd_vista'], $produto['pd_composicao'], $us_id, $data, $hora, $ip, $produto, $cadastrar_alterar);
	}
...
if(isset($_GET['deletarProduto'])){
	...
	deletarProduto($conexao, $prodCod);
}
...
function adicionarProduto ($conexao, $pd_empresa, $pd_matriz, $pd_cod, $pd_desc, $pd_marca, $pd_custo, $pd_vista, $pd_ean, $pd_codinterno, $pd_un, 
	...
	if($pd_csosn == 500){
		...
		$sql = "insert into produtos (pd_empresa, pd_matriz, pd_cod, pd_desc, pd_marca, pd_custo, pd_vista, pd_ean, pd_codinterno, pd_un, pd_lanca_site, 
						...
						values ($pd_empresa, $pd_matriz, '$pd_cod', '".utf8_decode($pd_desc)."', '$pd_marca', '$pd_custo', '$pd_vista', '$pd_ean', '$pd_codinterno', 
...
function editarProduto ($conexao, $pd_empresa, $pd_matriz, $pd_id, $pd_desc, $pd_codinterno, $pd_csosn, $pd_custo, $pd_ean, $pd_foto_url, $pd_grade, $pd_marca, $pd_markup, $pd_ncm,
	$pd_observ, $pd_prazo, $pd_subgrupo, $pd_un, $pd_vista, $pd_composicao, $us_id, $data, $hora, $ip, $produto, $cadastrar_alterar) {
...
function deletarProduto ($conexao, $prodCod){
