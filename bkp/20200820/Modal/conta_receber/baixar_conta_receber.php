                        ...
                        <div flex="" style="margin-left:15px;">
                            ...
                            <div layout="row" layout-wrap="">
                                <div flex="40" style="margin-right:15px;">
                                    ...
                                    <input type="text" class="form-control form-control-sm" id="totalDinheiro" ng-model="totalDinheiro" value="" autocomplete="off" money-mask>
                                </div>
                            ...
                            <div layout="row" layout-wrap="">
                                <div flex="40" style="margin-right:15px;">
                                    ...
                                    <input type="text" class="form-control form-control-sm" id="totalCartao" ng-model="totalCartao" value="" autocomplete="off" money-mask>
                                </div>
                                <div flex="45" style="margin-left:15px; margin-top:25px;" ng-show="false">
                            ...
                            <div layout="row" layout-wrap="">
                                <div flex="40" style="margin-right:15px;">
                                    ...
                                    <input type="text" class="form-control form-control-sm" id="totalCheque" ng-model="totalCheque" ng-value="" autocomplete="off" money-mask>
                                </div>
                                <div flex="45" style="margin-left:15px; margin-top:25px;" ng-show="false">
