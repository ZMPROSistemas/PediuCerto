                  <div class="modal fade" id="myModal2{{linha.idperfil}}" role="dialog" aria-labelledby="exampleModalLabel2" aria-hidden="true">
                      ...
                      <div class="modal-content">
                        ...
                        <form action="perfil_adiciona.php" method="post" autocomplete="off">
                              ...
                              <div class="col-md-12">
                                <div class="nav-tabs-custom">
                                  <ul class="nav nav-tabs">
                                    <li class="active"><a href="#tab_11{{linha.idperfil}}" data-toggle="tab">Cadastros</a></li>
                                    <li><a href="#tab_21{{linha.idperfil}}" data-toggle="tab">Treinos</a></li>
                                    <li><a href="#tab_31{{linha.idperfil}}" data-toggle="tab">Produtos</a></li>
                                    <li><a href="#tab_41{{linha.idperfil}}" data-toggle="tab">Relatórios</a></li>
                                    <li><a href="#tab_51{{linha.idperfil}}" data-toggle="tab">Financeiro</a></li>
                                    <li><a href="#tab_61{{linha.idperfil}}" data-toggle="tab">Recorrente</a></li>
                                    <li><a href="#tab_71{{linha.idperfil}}" data-toggle="tab">Administrativo</a></li>
                                  </ul>     
                                  <div class="tab-content">
                                <!-- Cadastros -->     
                                    <div class="tab-pane active" id="tab_11{{linha.idperfil}}">
                                      <table class="table table-bordered table-striped"> 
                                        <tbody>
                                            ...
                                            <td>  
                                              <input type="checkbox" class="flat-red" name="aluno_c" ng-model="linha.aluno_c" value="{{linha.aluno_c}}" ng-true-value="'S'" ng-false-value="'N'" ng-checked="linha.aluno_c"> Consultar                                                
                                            </td>
                                            <td>
                                              <input type="checkbox" class="flat-red" name="aluno_i" ng-model="linha.aluno_i" value="{{linha.aluno_i}}" ng-true-value="'S'" ng-false-value="'N'" ng-checked="linha.aluno_i"> Incluir
                                            </td>
                                            <td>
                                              <input type="checkbox" class="flat-red" name="aluno_a" ng-model="linha.aluno_a" value="{{linha.aluno_a}}" ng-true-value="'S'" ng-false-value="'N'" ng-checked="linha.aluno_a"> Alterar
                                            </td>
                                            <td>
                                              <input type="checkbox" class="flat-red" name="aluno_e" ng-model="linha.aluno_e" value="{{linha.aluno_e}}" ng-true-value="'S'" ng-false-value="'N'" ng-checked="linha.aluno_e"> Excluir
                                            </td>
                                            <td>
                                              <input type="checkbox" class="flat-red" name="aluno_r" ng-model="linha.aluno_r" value="{{linha.aluno_r}}" ng-true-value="'S'" ng-false-value="'N'" ng-checked="linha.aluno_r"> Relatórios
                                            </td>                          
                                          </tr>  
                                          <tr>
                                            <td>
                                ...
                                <!-- Treinos -->     
                                    <div class="tab-pane" id="tab_21{{linha.idperfil}}">
                                      <table class="table table-bordered table-striped">  
                                        <tbody>
                                          <tr>
                                            <td>
                                ...
                                <!-- Produtos -->     
                                    <div class="tab-pane" id="tab_31{{linha.idperfil}}">
                                      <table class="table table-bordered table-striped">
                                        <tbody>
                                          <tr>
                                            <td>
                                ...
                                <!-- Relatórios -->     
                                    <div class="tab-pane" id="tab_41{{linha.idperfil}}">
                                      <table class="table table-bordered table-striped">
                                        <tbody>
                                          <tr>
                                            <td>
                                ...
                                <!-- Financeiro -->     
                                    <div class="tab-pane" id="tab_51{{linha.idperfil}}">
                                      <table class="table table-bordered table-striped">
                                        <tbody>
                                          <tr>
                                            <td>
                                ...
                                <!-- Recorrente -->     
                                    <div class="tab-pane" id="tab_61{{linha.idperfil}}">
                                      <table class="table table-bordered table-striped">
                                ...
                                <!-- Administrativo -->     
                                    <div class="tab-pane" id="tab_71{{linha.idperfil}}">
                                      <table class="table table-bordered table-striped">                                       
                                        <tbody>
                                          <tr>
                                            <td>
                          ...
                          <div class="modal-footer">
                            <input type="hidden" name="idperfil" value="{{linha.idperfil}}">
