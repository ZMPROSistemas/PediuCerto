...
<style>
	...
	<?php if (base64_decode($empresa_acesso) == 0) {?>
										<div class="col-2" ng-init="empresa = '<?=base64_decode($empresa)?>'">
											<select class="form-control form-control-sm" id="empresa" ng-model="empresa" value{{empresa}}>
	...
	echo $dados_empresa["em_fanta"];
								    	...
								    	<div class="col-auto">
											<div class="input-group-btn">
												<button type="button" class="btn btn-outline-dark btn-sm" ng-click="ContasReceber(dataI | date : 'yyyy-MM-dd', dataF | date : 'yyyy-MM-dd', empresa, cliente, canc)" style="color: white;">
													<i class="fas fa fa-search" ></i>
												</button>
											</div>
								    	</div>
										...
										<div class="col-auto">
										<md-switch md-invert ng-model="status" ng-change="mudarStatus(status)">
						    ...
						    <div class="table-responsive px-0" style="overflow: hidden;">
								<table class="table table-striped pb-0" style="background-color: #FFFFFFFF; color: black; cursor: pointer;">
									...
									<tbody>
										<tr dir-paginate="contasReceber in contasReceber | filter:{ct_nome:buscaClient}| orderBy:'sortKey' | itemsPerPage:20" ng-class="contasReceber.ct_vencta == 'Vencido' ? 'venc' : contasReceber.ct_vencta == 'Hoje' ? 'vencH':''" ng-dblclick="clienteSelecionadoOK(contasReceber.ct_cliente_forn, contasReceber.ct_nome)">
								...
								<div ng-if="arrayNull == true">
									...
									<div class="alert-conta alert-primary col-lg-4" role="alert" style="width:100% !importante;">
										Empresa não possui contas a receber
									</div>
								...
								<div class="row align-items-center">
									<div class="col-3" style="text-align: left;">
										<div class="row justify-content-start">
											...
											<span style="color: black;" class="col-auto">Atrasadas: <b class="col-auto">{{totalcontasReceber[0].ct_valorVencida | currency: 'R$ '}}</b></span>
										...
										<div class="row justify-content-start">
											...
											<span style="color: black;" class="col-auto">Vencendo hoje: <b class="col-auto">{{totalcontasReceber[0].ct_valorHoje | currency: 'R$ '}}</b></span>
										...
										<div class="row justify-content-start">
											...
											<span style="color: black;" class="col-auto">A Receber: <b class="col-auto">{{totalcontasReceber[0].ct_valorAvencer | currency: 'R$ '}}</b></span>
