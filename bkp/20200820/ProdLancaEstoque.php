									...
									<form id="formProd">
										<div class="form-row">
											<div class="form-group col-10">
												...
												<input autofocus type="text" class="form-control form-control-sm" id="codProd" ng-value="produtoEncontrado[0].pd_desc" ng-model="formProd.codProd" placeholder="Informe o Código do Produto" onKeyUp="tabenter(event,getElementById('qtde'))" ng-blur="buscaProduto(formProd.codProd)" onkeypress='return event.charCode >= 48 && event.charCode <= 57' required>
											</div>
											<div class="form-group col-2">
												<label>Quantidade</label>
												<div class="input-group" ng-init="formProd.qtde  = 1">
													<input type="text" class="form-control form-control-sm" id="qtde" ng-value="formProd.qtde" ng-model="formProd.qtde" onKeyUp="tabenter(event,getElementById('btnIncluir'))" onfocus="this.focus();this.select()" ng-blur="pesquisaProdutoDesktop(formProd.codProd, formProd.qtde)" onkeypress='return event.charCode >= 48 && event.charCode <= 57' required>
...
?>															
								...
								<div class="card-footer p-2">
									<div class="form-row align-items-center">
										<div class="col-6">
											<button class="btn btn-outline-danger" style="color: white;"  ng-click="LimparTela()"><i class="fas fa-window-close"></i> Cancelar</button>
									...
									<form id="formProd">
										<div class="form-row">
											<div class="form-group col-12 input-group">
												...
												<input autofocus type="text" class="form-control form-control-sm" id="codProd" ng-model="formProd.codProd" placeholder="Informe o Código do Produto" ng-blur="pesquisaProduto(formProd.codProd)" onKeyUp="tabenter(event,getElementById('btnIncluir'))">
												<div class="input-group-btn">
							...
							<div class="modal-dialog modal-dialog-centered" role="document">
								<div class="modal-content">
									<div class="modal-header">
										<h5 style="color: black !important;"  class="modal-title" >Escolha a Empresa</h5>
									...
									<div class="modal-footer">
										...
										<button type="button" class="btn btn-primary" ng-if="empresaAcesso != '' && empresaAcesso != undefined" data-dismiss="modal" ng-click="lancarArray()">Salvar</button>
									</div>
								</div>
							</div>
						</div>
...
<?php }?>
			...
			$scope.excluirItem = function (itens) {
				...
				var index = $scope.produtoLista.indexOf(itens);
