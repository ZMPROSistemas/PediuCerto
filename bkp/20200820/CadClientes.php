									...
									<div class="form-row align-items-center" ng-init="empresa = '<?=base64_decode($empresa)?>'">
										...
										<?php if (base64_decode($empresa_acesso) == 0) {?>
											<div class="col-3">
												...
												<select class="form-control form-control-sm" id="empresa" ng-model="empresa" ng-change="dadosClienteComFiltro(empresa)" value="{{empresa}}">
					    	...
					    	<md-subheader class="md-no-sticky" style="background-color:#212529; color:#fff;">
							    ...
							    <div class="table-responsive px-0" style="overflow-y:auto ; overflow-x:hidden;">
									<table class="table table-striped" style="background-color: #FFFFFFFF; color: black;">
										...
										<tbody>
											<tr dir-paginate="cliente in dadosCliente | filter:buscaRapida | orderBy:'sortKey':reverse | itemsPerPage:20">
									...
									<div class="row align-items-center">
								    	<div class="col-4" style="text-align: left;">
											<div class="row justify-content-start">
									    		<span style="color: #303030FF;">Registros: <b>{{dadosCliente.length}}</b></span>
									    	</div>
										</div>
									</div>
								</div>	
...
/*		    var dadosClienteTotal = function () {
			...
			$scope.dadosClienteComFiltro = function (empresa) {
				$http({
					method: 'GET',
