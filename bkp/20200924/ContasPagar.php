  ...
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document" style="color: black;" >
    <div class="modal-content">
          ...
          <form id="formConta">
            <div class="row">
              ...
              <div class="form-group col-4" >
                ...
                <select class="form-control" id="selectEmpresa" ng-model="despesa.ct_empresa" name="select-simples-empresa">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-lg btn-primary" ng-click="AdicionarDespesa(despesa, selecionarCaixa, bc_codigo, vencimento | date: 'yyyy-MM-dd')" ng-if="despesa.ct_docto && despesa.ct_tipdoc && despesa.ct_empresa && despesa.ct_historico && notaParcelas[0].vezes && despesa.ct_cliente_forn">Lançar Conta</button>
      </div>
    </div>
  </div>
</div>
