                ...
                <div class="container-fluid">
                    <form name="form" id="form" novalidate>
                        <div class="form-row">
                            ...
                            <div class="form-group col-3">
                                <label>Parcela</label>
                                <input type="text" class="form-control form-control-sm" ng-model="contas[0].ct_parc" ng-blur="verificaCampo(contas[0].ct_parc)" parcela-dir>
                            </div>

                            <div class="form-group col-5">
                                <label>Vencimento </label> 
                                <input type="text" class="form-control form-control-sm" ng-model="contas[0].ct_vencto" ng-blur="verificaCampo(contas[0].ct_vencto)">
                            </div>

                            <div class="form-group col-4" >
                                <label>Valor</label> 
                                <input type="text" class="form-control form-control-sm" ng-model="contas[0].ct_valor" ng-blur="verificaCampo(contas[0].ct_valor)" money-dir>
                            </div>
