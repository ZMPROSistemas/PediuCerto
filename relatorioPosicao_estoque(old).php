...
<div show-on-desktop>-->
		  		...
		  		<nav aria-label="breadcrumb">
					<ol class="breadcrumb p-0">
						...
						<li class="breadcrumb-item active" aria-current="page">Relatório De Posição De Financeira De Estoque</li>
	...
	echo $dados_empresa["em_fanta"];
						    	...
						    	<div class="form-group col-md-2 col-12 pt-3" ng-init="estoque = '0'">

						    		<label for="periodo">Emitir Estoque</label>

						    		<select name="estoque" class="form-control form-control-sm capoTexto" id="estoque" ng-model="estoque" value="">
						    			<option value="0" selected="selected">Positivo</option>
						    	...
						    	<div class="form-group col-md-2 col-10" style="margin-right: -10px !important; margin-left: -34px !important;">
								   <div style="margin-top: 40px;">
									...
									<button class="btn btn-outline-dark" lass="btn btn-outline-dark" style="color: white;" ng-click="bsusca(empresa, dataI | date: 'yyyy-MM-dd', dataF | date: 'yyyy-MM-dd', subgrupo, estoque)"><i class="fas fa-search"></i></button>
					    	...
					    	<div show-on-desktop>
					    		...
					    		<table id="tabela" class="table table-striped table-borderless" style="background-color: #FFFFFFFF; color: black;">

									<thead class="thead-dark">
										<tr style="font-size: 1.1em !important;">
											<th scope="col" style=" font-weight: normal;" ng-click="ordenar('pd_cod')">Cód
											</th>
											<th scope="col" style=" font-weight: normal;" ng-click="ordenar('em_fanta')" style="width: 180px">Empresa
											</th>
											<th scope="col" style=" font-weight: normal;" ng-click="ordenar('pd_desc')">Descrição
											</th>
											<th scope="col" style=" font-weight: normal;" ng-click="ordenar('pd_un')">UN
											</th>
											<th scope="col" style=" font-weight: normal;" ng-click="ordenar('descricao')">SubGrupo
											</th>
											<th scope="col" style=" font-weight: normal;" ng-click="ordenar('es_est')">Est
											</th>
											<th scope="col" style=" font-weight: normal;" ng-click="ordenar('es_est')">Custo
											</th>
											<th scope="col" style=" font-weight: normal;" ng-click="ordenar('pd_vista')">Vista
											</th>
											<th scope="col" style=" font-weight: normal;" ng-click="ordenar('c_total')">C.Total
											</th>
											<th scope="col" style=" font-weight: normal;" ng-click="ordenar('v_total')">V.Total
											</th>
										</tr>
...
<?php }?>
			...
			subgrupo();
			 ...
			 var relatorioSubGrupo = function (empresa, dataI, dataF,subgrupo,estoque) {
				$http({
					method: 'GET',
					url: $scope.urlBase+'relatorio_posicao_estoque.php?relatorio=S&relatorioSubGrupo=S&us_id=<?=$us_id?>&e=<?=$empresa?>&eA=<?=$empresa_acesso?>&empresa='+empresa+'&subgrupo='+subgrupo+'&estoque='+estoque+'&dataI='+dataI+'&dataF='+dataF
				}).then(function onSuccess(response){
			...
			//        alert("idtreinoAluno");
			 ...
			 var relatorioRegistro = function (empresa, dataI, dataF,subgrupo,estoque) {
				$http({
					method: 'GET',
					url: $scope.urlBase+'relatorio_posicao_estoque.php?relatorio=S&dadosRelatorio=S&us_id=<?=$us_id?>&e=<?=$empresa?>&eA=<?=$empresa_acesso?>&empresa='+empresa+'&subgrupo='+subgrupo+'&estoque='+estoque+'&dataI='+dataI+'&dataF='+dataF
				}).then(function onSuccess(response){
			...
			<?php }?>
				...
				relatorioSubGrupo(empresa, dataI, dataF,subgrupo,estoque);
				relatorioRegistro(empresa, dataI, dataF,subgrupo,estoque);
...
<?php }?>
    		...
    		var header = function (data) {
		        ...
		        doc.text("Relatório De Posição De Financeira De Estoque", 85, 27);
		        doc.setFontSize(12);
		        doc.setTextColor(40);
