													...
													<form id="formNota">
													    ...
													    <div class="row">
															<div class="form-group col-md-5" >
																...
																<select class="form-control" id="formaPagto" ng-model="ct_tipdoc" ng-blur="ConsultaCaixa(ct_tipdoc)" onKeyUp="tabenter(event,getElementById('formaPagto'))" ng-change="numParcelasNota(dadosNotaCompra[0].cp_emis, totalCompra, numParcelas, ct_tipdoc)">
				...
				$http({
					...
					method: 'POST',
					 headers: {
			          ...
			          url: $scope.urlBase+'SalvaCompra.php?&us_id=<?=$us_id?>&cx='+selecionarCaixa+'&bc_codigo='+btoa(bc_codigo)
		    ...
		    $scope.numParcelasNota = function(cp_vencto, valor, numParcelas, ct_tipdoc) {
		    	...
		    	if (numParcelas > 12) {
		    		...
		    		alert("Número de parcelas inválido.");
	  				...
	  				$http({
					method: 'GET',
					url: $scope.urlBase+'NumParcelaCompra.php?vencimento='+cp_vencto+'&valorTotal='+valor+'&numParcelas='+numParcelas+'&tipoDocto='+ct_tipdoc
					}).then(function onSuccess(response){
