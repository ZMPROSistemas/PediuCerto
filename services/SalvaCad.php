...
if ($editarCadastrar == 'C') {
	insereEmpresa($conexao, $em_razao, $em_fanta, $em_end, $em_end_num, $em_bairro, $em_cid, $em_uf, $em_cep, $em_cnpj, $em_insc, $em_fone, $em_email, $em_responsavel, $em_cont_nome, $em_cont_fone, $em_cont_email, $empresa, $cnpn_matriz, $ramo, $data, $hora, $ip, $us, $em_logo, $filial);
	//echo "C";

}
if ($editarCadastrar == 'E') {
	editarEmpresa($conexao, $em_razao, $em_fanta, $em_end, $em_end_num, $em_bairro, $em_cid, $em_uf, $em_cep, $em_cnpj, $em_insc, $em_fone, $em_email, $em_responsavel, $em_cont_nome, $em_cont_fone, $em_cont_email, $id, $data, $hora, $ip, $us, $em_logo, $empresa, $filial);
	//echo "E";

}

function insereEmpresa($conexao, $em_razao, $em_fanta, $em_end, $em_end_num, $em_bairro, $em_cid, $em_uf, $em_cep, $em_cnpj, $em_insc, $em_fone, $em_email, $em_responsavel, $em_cont_nome, $em_cont_fone, $em_cont_email, $empresa, $cnpn_matriz, $ramo, $data, $hora, $ip, $us, $em_logo, $filial) {
...
'$em_logo'
	...
	if (mysqli_insert_id($conexao) <= 0) {
		...
		$filial = mysqli_insert_id($conexao);
		echo 1;
		logSistema($conexao, $data, $hora, $ip, $us, 'Empresa cadastrada ' . $em_razao . '', $empresa, $filial);

		atualizaCache($conexao, $empresa, $filial, 'empresa');
	}
	//echo $query;
	return $inserir;
}

function editarEmpresa($conexao, $em_razao, $em_fanta, $em_end, $em_end_num, $em_bairro, $em_cid, $em_uf, $em_cep, $em_cnpj, $em_insc, $em_fone, $em_email, $em_responsavel, $em_cont_nome, $em_cont_fone, $em_cont_email, $id, $data, $hora, $ip, $us, $em_logo, $empresa, $filial) {
	...
	if (mysqli_affected_rows($conexao) <= 0) {
		...
		echo 1;
		logSistema($conexao, $data, $hora, $ip, $us, 'Empresa editada ' . $em_razao . '', $empresa, $filial);
		
		atualizaCache($conexao, $empresa, $id, 'empresa');
	}
	//echo $sql;
}
