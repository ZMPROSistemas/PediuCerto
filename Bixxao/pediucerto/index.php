...
define('DB_SERVER', 'db-brasilmobile.caungtcgcwfr.sa-east-1.rds.amazonaws.com');
define('DB_USERNAME', 'root');
define('DB_PASSWORD', 'lxmcz2016');
define('DB_DATABASE', 'zmpro');
...
*/
    ...
    try{
        $pdo = new PDO("mysql:dbname=". DB_DATABASE ."; charset=utf8; host=". DB_SERVER, DB_USERNAME, DB_PASSWORD, array(PDO::MYSQL_ATTR_INIT_COMMAND=>"SET NAMES utf8"));
    ...
    if($producao == true){
        ...
        $url= str_replace('zmpro/'.$estabelecimento.'/pediucerto/','', $_SERVER['REQUEST_URI']);
    }
...
<html lang="pt-br" ng-app="PediuCerto" ng-cloak> 
    <head>
        ...
        <?php if(($route1[1] != 'verifica') 
                ...
                && ($route1[1] != 'criar-conta')
                && ($route1[1] != '')){
            echo '<title>'. $empresa['em_fanta'].'</title>';
        } else{
        ...
        <script charset="UTF-8" src="https://web.webpushs.com/js/push/4addf25c537e2f1bb7b6d92dea0bd3a7_0.js" async></script>
    ...
    <body>
        ...
        <div ng-controller="PediuCertoCtrl" class="container-app">
            ...
            <div class="menu-top" style="width:100%; height:60px; top: 0;" ng-if="perfil != null">
                <md-button href="<?=$urlAssets?>{{perfil[0].pe_site}}" class="md-fab md-fab-top-right" style="margin-top:-18px; stop: 5px; padding: 0;" >
                    <i class="fas fa-bars" style="margin-top:13px; border-radius: 50%; width: 100%; font-size:30px;"></i>
            ...
            <div class="alert alert-success blocoApp" role="alert" style="position:absolute; right:0px; margin-top:10px; display:none;">
                <h6 class="alert-heading">Deseja fazer a instalação do aplicativo</h6>
                <hr>
                <button type="button" class="btn btn-secondary btn-sm pull-right">Cancelar</button>
                <button type="button" class="btn btn-primary btn-sm pull-right">Instalar</button>
            </div>
    ...
    <?php
     ...
     if($route['page'] == 'ERRO 404'){
        ...
        include_once "controller/item/item.php";
     }

     else if($route['page'] == 'produto'){
        
        include_once "controller/produto/produto.php";
     }
     else if($route['page'] == 'produtoPizza'){
        
        include_once "controller/produto/produtoPizza.php";
     }
