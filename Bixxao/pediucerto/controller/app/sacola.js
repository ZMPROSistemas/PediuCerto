...
var somarTotalSacola = function(){
    ...
    $scope.totalSacolaQtn = $scope.sacola.reduce(function (accumulador, total) {return accumulador + parseFloat(total.pd_quantidade);}, 0);
    $scope.totalSacolaValor = $scope.sacola.reduce(function (accumulador, total) {return accumulador + parseFloat(total.v_total);}, 0);
    ...
    for (i = 0; i < $scope.sacola.length; i++) {
        ...
        console.log($scope.totalSacolaValor);   
    }*/
